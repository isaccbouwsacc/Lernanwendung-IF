...
#### Anmerkung: LLMs (Sprachmodelle) können Fehler machen, insbesondere kleinere, lokal ausführbare Modelle! (<20B Parameter und eventuell auch abhängig von bwp (Bits Per Weight) und Floating Point Precision Types, die zum ladend verwendet wurden)
